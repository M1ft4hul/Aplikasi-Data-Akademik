...
$title = " Perpustakaan SMK 4 KENDARI";
$obj_pdf->SetTitle($title);
$obj_pdf->SetHeaderData("download (1650 x 1080).jpg", PDF_HEADER_LOGO_WIDTH, $title, "Laporan Pengembalian Buku");
...
<table border="1">
    <thead align="center">
        <tr align="center">
            ...
            <th width="6%" style="text-align: center;"><b>Kode Kartu</b></th>
        ...
        if ($op['status'] == 1) {
            ...
            <tr>
                ...
                <td align="center" width="5%"><?php //$buku=$op7['id_kelas'];
                                                        foreach ($data_kelas->result_array() as $op5) {
                                                            if ($op5['id_kelas'] == $idk) {
                                                                echo $op5['kelas'];
                                                            }
                                                        } ?>
                ...
                <td width="6%" style="text-align: center;"><?php

                                                                    foreach ($data_anggota->result_array() as $key => $op6) {
                                                                        if ($op6['id_anggota'] == $buku) {
                                                                            echo $op6['kode_kartu'];
                                                                        }
                                                                    }
                                                                    ?>
