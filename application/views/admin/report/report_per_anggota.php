    ...
    <div class="box-body">
      ...
      <?php if (count($data_pinjam->result_array())) { ?>
        <table width="100%">
          <tr>
            <td width="10%">
              <h5><b> Id Anggota </b></h5>
            </td>
            <td>
              <h5><b>:</b></h5>
            </td>
            <td>
              <h5><b><?php foreach ($data_pinjam->result_array() as $key => $value1) {
          ...
          <tr>
            <td>
              <h5><b> Jumlah Peminjaman</b></h5>
            </td>
            <td>
              <h5><b> : </b></h5>
            </td>
            <td>
              <h5><b><?php $jumpinjam = count($data_pinjam->result_array());
                        echo $jumpinjam;
                        echo  "  Kali";   ?>
                </b></h5>
            </td>
          ...
          <tr>
            <td>
              <h5><b> keterlambatan</b></h5>
            </td>
            <td>
              <h5><b> : </b></h5>
            </td>
            <td>
              <h5><b><?php echo number_format($pers = 100 - (($jum / $jumpinjam) * 100), 2, '.', '');
                        echo " %";  ?>
                </b></h5>
            </td>
          </tr>
