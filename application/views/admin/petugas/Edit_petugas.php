  ...
  <form class="form-horizontal" method="post" <?php echo form_open_multipart('admin/Petugas/Update'); ?>
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <input type="text" value="<?php echo $petugas['nama']; ?>"  class="form-control" name="nama" placeholder="Nama Lengkap" required >
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <input type="text" value="<?php echo $petugas['alamat']; ?>"  class="form-control" name="alamat" placeholder="alamat" required>
                  </div>
                  ...
                  <div class="col-sm-3">
                    ...
                    <div class="form-check form-check-inline">
                      <label class="form-check-label">
                        <input class="form-check-input" type="radio" name="jk" <?php echo ($petugas['jenis_kelamin'] == "L") ? 'checked' : '' ?> id="inlineRadio1" value="L" required> Laki - Laki
                      </label>
                    </div>
                    <div class="form-check form-check-inline">
                      <label class="form-check-label">
                        <input class="form-check-input" type="radio" name="jk" <?php echo ($petugas['jenis_kelamin'] == "A") ? 'checked' : '' ?> id="inlineRadio2" value="P" required> Perempuan
                      </label>
                    </div>
                  </div>
                  </div>
...
?>
               ...
               <div class="form-group">
                  ...
                  <div class="col-sm-3">
                    ...
                    <div class="form-check form-check-inline">
                      <label class="form-check-label">
                        <input class="form-check-input" type="radio" name="stts" <?php echo ($login['stts'] == "admin") ? 'checked' : '' ?> id="inlineRadio1" value="admin" required> Admin
                      </label>
                    </div>
                    <div class="form-check form-check-inline">
                      <label class="form-check-label">
                        <input class="form-check-input" type="radio" name="stts" <?php echo ($login['stts'] == "petugas") ? 'checked' : '' ?> id="inlineRadio2" value="petugas" required> Petugas
                      </label>
                    </div>
                  </div>
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                  <img style="width:64px;height:64px" src="<?php echo base_url(); ?>gambar_petugas/<?php echo $petugas['img']; ?>" required>
               ...
               <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <input type="text" value="<?php echo $petugas['hp']; ?>"  class="form-control" name="hp" placeholder="No HP" required >
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-5">
                   <textarea class="form-control" value="<?php echo $petugas['ket']; ?>" name="ket" rows="4" placeholder="Keterangan" required></textarea>
                  </div>
                </div>
              </div>
              <div class="col-sm-4">
