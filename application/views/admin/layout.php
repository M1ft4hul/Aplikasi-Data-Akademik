...
<body class="hold-transition skin-purple sidebar-mini">
  <div class="wrapper">
    ...
    <header class="main-header">
      ...
      <a href="<?php echo base_url(); ?>admin/home" class="logo">
        ...
        <span class="logo-lg">LMS | Admin </span>
      </a>
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu">
          ...
          <li class="treeview">
            ...
            <ul class="treeview-menu">
              <li><a href="<?php echo base_url(); ?>admin/Report"><i class="fa fa-book"></i>Laporan Pemasokan Buku</a></li>
              <li><a href="<?php echo base_url(); ?>admin/Report/pengembalian"><i class="fa fa-book"></i>Laporan Pengembalian</a></li>
            </ul>
          </li>
          <li class="header">DENDA</li>
          <li><a href="<?php echo base_url(); ?>admin/Denda"><i class="fa fa-usd"></i> <span>Denda</span></a></li>
          <li class="header">INPUT PETUGAS</li>
    ...
    <!-- skrip code php dibawah ini untuk flash message-->

    <?php

    // class Flasher extends MY_Controller {
    ...
    <div class="content-wrapper">
      <!-- Content Header (Page master buku) -->
    ...
    <footer class="main-footer">
      ...
      <div class="pull-right hidden-xs">
        Modified by @Miftahul jannah
      </div>
      <!-- Default to the left -->
      <strong>Copyright &copy; 2019 Miftahul Jannah</a>.</strong> SMK 4 KENDARI.
    </footer>
  ...
  <!-- script dibawah ini untuk memanggil file sweetalert js dan file js kita sendiri untuk sweet alert-->
  <script src="<?php echo base_url(); ?>assets/sweetalert/sweetalert2.all.min.js"></script>
  <script src="<?php echo base_url(); ?>assets/sweetalert/mysweetalert.js"></script>
  ...
  <script>
    ...
    // dibawah ini adalah fungsi untuk delete nya ada di layout
