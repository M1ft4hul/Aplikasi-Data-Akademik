...
<div class="box box-solid box-primary">
    ...
    <div class="box-body">
        <div class="btn-group"><a href="<?php echo base_url(); ?>admin/Rak/create" class="btn btn-success" role="button" data-toggle="tooltip" title="Tambah Rak"><i class="fa fa-plus"></i> Tambah Rak</a></div>
