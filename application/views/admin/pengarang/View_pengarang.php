...
<div class="box box-solid box-primary">
    ...
    <div class="box-body">
        <div class="btn-group"><a href="<?php echo base_url(); ?>admin/Pengarang/create" class="btn btn-success" role="button" data-toggle="tooltip" title="Tambah Pengarang"><i class="fa fa-plus"></i> Tambah Pengarang</a></div>
