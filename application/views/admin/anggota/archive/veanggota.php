            ...
            <form class="form-horizontal">
              <div class="box-body">
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Kode Kartu</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="kode_kartu" value="<?php echo $old_value['kode_kartu']?>" id="inputEmail3">
                  </div>
                </div>
