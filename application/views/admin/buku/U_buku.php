...
<div class="box box-solid box-primary">
  ...
  <div class="box-body">
    ...
    <form class="form-horizontal" method="post" <?php echo form_open_multipart('admin/Buku/update_buku'); ?> <?php
      ...
      <div class="form-group">
        ...
        <div class="col-sm-5">
          <textarea class="form-control" value="<?php echo $op['ket']; ?>" name="keterangan" rows="4" placeholder="Keterangan tentang buku ini"></textarea>
        </div>
      </div>
      <div class="form-group">
        <label class="col-sm-2 control-label">Foto</label>
        <div class="col-sm-4">
          <img style="width:64px;height:64px" src="<?php echo base_url(); ?>gambar_petugas/<?php echo $op['img']; ?>" required>
