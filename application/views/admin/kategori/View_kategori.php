...
<div class="box box-solid box-primary">
    ...
    <div class="box-body">
        <div class="btn-group"><a href="<?php echo base_url(); ?>admin/kategori/create" class="btn btn-success" role="button" data-toggle="tooltip" title="Tambah Kategori"><i class="fa fa-plus"></i> Tambah Kategori</a></div>
