...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo base_url();?>petugas/Home" class="logo">
      ...
      <span class="logo-lg">LMS | Petugas</span>
    </a>
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="<?php echo base_url(); ?>petugas/Profil" class="btn btn-default btn-flat">Profile</a>
                </div>
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
              <li><a href="<?php echo base_url(); ?>petugas/Report"><i class="fa fa-book"></i>Laporan Pemasokan Buku</a></li>
              <li><a href="<?php echo base_url(); ?>petugas/Report/pengembalian"><i class="fa fa-book"></i>Laporan Pengembalian</a></li>
          </ul>
        </li>
...
$(document).ready(function() {
    $('#tabel_buku').DataTable( {
      ...
      var tabel = $('#tabel_buku').DataTable();
      $('#tabel_buku tbody').on('click', 'td.details-control',function (){
        var tr = $(this).closest('tr');
        var row = table.row( tr );
        ...
        if ( row.child.isShown() ) {
            ...
            row.child( format_buku1(row.data()) ).shown();
            tr.addClass('shown');
        }
      });
});
