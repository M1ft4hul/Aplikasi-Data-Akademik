...
<div class="box box-solid box-primary">
  <div class="box-header with-border">
   ...
   <table id="tabel_buku" class="table table-striped table-bordered" cellspacing="0" width="100%">
        <thead>
            <tr>
                <th width="5%">No</th>
                <th >ID Anggota</th>
...
<?php
  ...
  ?>            
   ...
   <div> <h3><a href="<?php echo base_url(); ?>petugas/Report/pdf_kembali" class="btn btn-warning" role="button" data-toggle="tooltip"><i class="fa fa-print"></i> Print PDF</a></h3> </div>
    <div> <h3><a href="<?php echo base_url(); ?>petugas/Report/excel1" class="btn btn-danger" role="button" data-toggle="tooltip"><i class="fa fa-print"></i> Export Excel</a></h3> </div>
  </div>
