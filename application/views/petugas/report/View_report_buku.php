...
<?php
  ...
  ?>            
    ...
    <div> <h3><a href="<?php echo base_url(); ?>petugas/report/pdfkan" class="btn btn-warning" role="button" data-toggle="tooltip"><i class="fa fa-print"></i> Print PDF</a></h3> </div>
    <div> <h3><a href="<?php echo base_url(); ?>petugas/report/excel" class="btn btn-danger" role="button" data-toggle="tooltip"><i class="fa fa-print"></i> Export Excel</a></h3> </div>
  </div>
