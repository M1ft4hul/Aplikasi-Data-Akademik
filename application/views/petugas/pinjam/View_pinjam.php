...
<div class="box box-solid box-primary">
  ...
  <div class="btn-group">
    <td>
     <div align ="left">
      <a  href="<?php echo base_url(); ?>petugas/Pinjam"  class="btn btn-danger" role="button" data-toggle="tooltip" title="Pinjam"></i>Data Pinjam</a>
      <a  href="<?php echo base_url(); ?>petugas/Pinjam/vw_kembali"  class="btn btn-danger" role="button" data-toggle="tooltip" title="Kembali"></i>Data Kembali</a>
      </div>
   </td>
  </div>
  </div>
  ...
  $no = 1;
    ...
    ?>
            <tr>
                ...
                <td><?php $kode_kartu=$op['id_anggota'];
                    foreach ($anggota ->result_array()  as $op2) {
                      if($op2['id_anggota']==$kode_kartu){
                          echo $op2['kode_kartu'];
                      }
                    }?></td>
