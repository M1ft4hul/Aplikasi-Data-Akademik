  ...
  <div class="box-header with-border">
   ...
   <div class="box-body">
	...
	<form class="form-horizontal" method="post"  action="<?php echo base_url(); ?>petugas/Pinjam/Edit_pinjam" role="form">
              <div class="box-body">
                <div class="form-group">
                 <label class="col-sm-2 control-label">Kode Kartu</label>
                  <div class="col-sm-5">
    ...
    ?>
        ...
        ?>
                                <option value="<?php echo $op2['id_anggota']; ?>" selected><?php echo $op2['kode_kartu']; ?></option>
                              <?php
}
    if ($op2['id_anggota'] != $pinjam['id_anggota']) {?>
                                <option value="<?php echo $op2['id_anggota']; ?>"><?php echo $op2['kode_kartu']; ?></option>
                              <?php
}
    ?>
                            <?php
