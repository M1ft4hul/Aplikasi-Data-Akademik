...
class Buku_model extends CI_Model
{
    ...
    public function deletedetData($table, $col, $id_det_buku)
    {
    ...
    public function get_detail12($table, $col1, $col2, $id, $tgl)
    {
    ...
    public function get_detail1($table, $id_table, $id)
    {
    ...
    public function get_detail123($table, $id_table, $id)
    {
        $this->db->where($id_table, $id);
        $p = $this->db->get($table);
        return $p;
    ...
    public function get_detail2($table, $id_table, $id)
    {
        $this->db->where($id_table, $id);
